...
def farm_action(
    ...
    if (location_of_the_cows == "pasture" and time_of_day == "night") or (
        location_of_the_cows == "pasture" and weather == "rainy"
    ):
        return "take cows to cowshed"
    elif cow_milking_status is True and location_of_the_cows == "cowshed":
        return "milk cows"
    elif cow_milking_status is True and location_of_the_cows == "pasture":
